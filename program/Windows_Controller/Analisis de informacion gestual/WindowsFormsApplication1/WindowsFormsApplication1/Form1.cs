...
/* 
 ...
 ANALISIS DE INFORMACIÓN GESTUAL
        ...
        private void timer1_Tick(object sender, EventArgs e)//Temprizador de la aplicación
        {
            ...
            if (i == 0)//Condición para ejecutar solo al inicio una vez
            {
               SpeechSynthesizer synth = new SpeechSynthesizer();//Instanciación de objeto de sistesis de voz
                ...
                synth.Speak("El módulo de análisi de información gestual ha sido iniciado correctamente");
                synth.Speak("Situe las manos sobre el dispositivo leap motion y comience a analizar el control de robot por medios gestuales");
